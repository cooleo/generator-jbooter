...
function writeFiles() {
    return {
        saveRemoteEntityPath: function() {
            ...
            this.copy(this.microservicePath + '/' + this.jbooterConfigDirectory + '/' + this.entityNameCapitalized + '.json', this.destinationPath(this.jbooterConfigDirectory + '/' + this.entityNameCapitalized + '.json'));
        },
