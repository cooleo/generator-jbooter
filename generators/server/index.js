...
var JbooterServerGenerator = generators.Base.extend({});

util.inherits(JbooterServerGenerator, scriptBase);

/* Constants used throughout */
const constants = require('../generator-constants'),
    QUESTIONS = constants.SERVER_QUESTIONS;

module.exports = JbooterServerGenerator.extend({
    ...
    initializing: {
        ...
        setupServerVars: function () {
            ...
            if (this.jbooterVersion === undefined) {
                this.jbooterVersion = packagejs.version;
            }
    ...
    prompting: {
        ...
        setSharedConfigOptions: function () {
            ...
            this.DOCUMENTATION_URL = constants.JBOOTER_DOCUMENTATION_URL;
            this.DOCUMENTATION_ARCHIVE_URL = constants.JBOOTER_DOCUMENTATION_URL + constants.JBOOTER_DOCUMENTATION_ARCHIVE_PATH + 'v' + this.jbooterVersion;
        }
    },
