    ...
    var prompts = [
        ...
        },
        {
            ...
            choices: [
                ...
                {
                    value: 'uaa',
                    name: '[BETA] Authentication with JBooter UAA server (the server must be generated separately)'
                }
            ],
            default: 0
        },
        {
            ...
            validate: function (input) {
                ...
                if (uaaAppData && uaaAppData.baseName && uaaAppData.applicationType === 'uaa') {
                    ...
                    return 'Could not find a valid JBooter UAA server in path "' + input + '"';
                }
            }.bind(this)
        },
        {
            ...
            choices: [
                {
                    value: 'eureka',
                    name: 'JBooter Registry (using Eureka and Spring Cloud Config)'
                },
                {
                    value: 'consul',
...
function getUaaAppName(input) {
    ...
    if (shelljs.test('-f', fromPath)) {
        ...
        if (fileData && fileData['generator-jbooter']) {
            return fileData['generator-jbooter'];
        } else return false;
    } else {
        return false;
    }
