...
function writeFiles() {
    return {
        ...
        writeDockerFiles: function () {
            ...
            if (this.applicationType === 'microservice' || this.applicationType === 'gateway' || this.applicationType === 'uaa') {
                ...
                if (this.serviceDiscoveryType === 'eureka') {
                    this.template(DOCKER_DIR + '_jbooter-registry.yml', DOCKER_DIR + 'jbooter-registry.yml', this, {});
        ...
        writeServerJavaConfigFiles: function () {
            ...
            this.template(SERVER_MAIN_SRC_DIR + 'package/config/_JBooterProperties.java', javaDir + 'config/JBooterProperties.java', this, {});
            ...
            if (this.databaseType === 'cassandra') {
                ...
                this.template(SERVER_MAIN_SRC_DIR + 'package/config/metrics/_JBooterHealthIndicatorConfiguration.java', javaDir + 'config/metrics/JBooterHealthIndicatorConfiguration.java', this, {});
