...
@EnableConfigurationProperties({ JBooterProperties.class<% if (databaseType == 'sql') { %>, LiquibaseProperties.class<% } %> })
<%_ if (applicationType == 'microservice' || applicationType == 'gateway' || applicationType == 'uaa') { _%>
...
public class <%= mainClass %> {
     ...
     * <p>
     * You can find more information on how profiles work with JBooter on <a href="http://jbooter.github.io/profiles/">http://jbooter.github.io/profiles/</a>.
     */
    @PostConstruct
