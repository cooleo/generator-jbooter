...
public class RateLimitingFilter extends ZuulFilter {
    ...
    public RateLimitingFilter(RateLimitingRepository rateLimitingRepository, JBooterProperties jBooterProperties) {
        this.rateLimitingRepository = rateLimitingRepository;
        this.rateLimit = jBooterProperties.getGateway().getRateLimiting().getLimit();
    }
