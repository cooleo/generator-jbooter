...
public class UaaConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    public static class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
        ...
        public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
            resources.resourceId("jbooter-uaa").tokenStore(tokenStore);
        }
    }
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        clients.inMemory()
            ...
            .and()
            .withClient(jBooterProperties.getSecurity().getClientAuthorization().getClientId())
            .secret(jBooterProperties.getSecurity().getClientAuthorization().getClientSecret())
            .scopes("web-app")
            .autoApprove(true)
