...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    public void customize(ConfigurableEmbeddedServletContainer container) {
        ...
        // IE issue, see https://github.com/jbooter/generator-jbooter/pull/711
    ...
    private void initCachingHttpHeadersFilter(ServletContext servletContext,
        ...
        FilterRegistration.Dynamic cachingHttpHeadersFilter =
            servletContext.addFilter("cachingHttpHeadersFilter",
                new CachingHttpHeadersFilter(jBooterProperties));
    ...
    @Bean
    @ConditionalOnProperty(name = "jbooter.cors.allowed-origins")
    public CorsFilter corsFilter() {
        log.debug("Registering CORS filter");
        UrlBasedCorsConfigurationSource source = new UrlBasedCorsConfigurationSource();
        CorsConfiguration config = jBooterProperties.getCors();
