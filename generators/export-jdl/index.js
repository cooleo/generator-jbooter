...
module.exports = ExportJDLGenerator.extend({
    ...
    default: {
        ...
        parseJson: function () {
            this.log('Parsing entities from .jbooter dir...');
            try {
                let entities = {};
                ...
                jhiCore.convertJsonServerOptionsToJDL({'generator-jbooter': this.config.getAll()}, this.jdl);
            } catch (e) {
    ...
    writing: function () {
        let content = '// JDL definition for application \'' + this.baseName + '\' generated with command \'yo jbooter:export-jdl\'\n\n' + this.jdl.toString();
